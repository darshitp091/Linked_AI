...
const comparisonFeatures = [
  ...
  { name: 'Scheduling', free: 'Basic', pro: 'Advanced', standard: 'Unlimited' },
  { name: 'Auto-posting', free: true, pro: true, standard: true },
  { name: 'Social calendar', free: false, pro: true, standard: true },
  { name: 'Support', free: 'Email', pro: 'Priority', standard: 'Dedicated' },
]
